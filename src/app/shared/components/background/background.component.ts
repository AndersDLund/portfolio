...
export class BackgroundComponent implements OnInit {
  ...
  accidentalDescription = {
    ...
    paragraphs: [
      ...
      `While I was working for Audi, we used an app called Record 360 to track vehicle damages.
      The app served its purpose but it was essentially just a medium to email pictures and videos.`,

      `I had an idea to improve the app by making it a little more hands-off by using deep
      ...
      `I found that I could attend a six month coding bootcamp
      for less money than it would take to pay someone else to make the app, which is right around when I discovered Galvanize.`,

      `Accidental.io (my app) was my final project at galvanize. I built it in about two weeks using a language I didn’t know prior.
